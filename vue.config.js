...
module.exports = {
  chainWebpack: config => {
    ...
    config.resolve.alias.set('sass', path.resolve(__dirname, 'src/styles/sass'))
    config.resolve.alias.set('stylus', path.resolve(__dirname, 'src/styles/stylus'))
    config.resolve.alias.set('tests', path.resolve(__dirname, 'tests'))
    config.resolve.alias.set('@freshinup/core-ui', path.resolve(__dirname))
